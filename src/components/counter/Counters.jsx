...
const stats = [
  {
    icon: <PartyPopper className="w-10 h-10 text-purple-600" />,
    end: 300,
    suffix: "+",
  ...
  {
    icon: <Cake className="w-10 h-10 text-purple-600" />,
    end: 200,
    suffix: "+",
    title: "Birthday Celebrations",
    subtitle: "Made Extra Special",
  },
  {
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-purple-50 py-20">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="mt-4 text-4xl md:text-6xl font-bold text-slate-800">
            Creating Memories,
            <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stats.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 p-10 text-center"
            >
              <div className="w-20 h-20 rounded-full bg-purple-100 flex items-center justify-center mx-auto mb-6">
                {item.icon}
              </div>

              <h3 className="text-5xl font-bold bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-500 bg-clip-text text-transparent">
                <CountUp
                  end={item.end}
                  duration={2.5}
              ...
              <h4 className="mt-3 text-2xl font-semibold text-slate-800">
                {item.title}
              </h4>
        ...
        <div className="mt-16 rounded-3xl bg-gradient-to-r from-purple-700 via-violet-700 to-fuchsia-700 p-8 flex flex-col lg:flex-row items-center justify-between gap-8 text-white">
          <div>
            ...
            <p className="mt-4 text-purple-100">
              Every celebration deserves creativity, planning and flawless
              execution.
            </p>
          </div>
          ...
          <a
            href="/form"
            className="flex items-center gap-3 bg-white text-purple-700 px-8 py-4 rounded-2xl font-semibold hover:bg-purple-100 hover:scale-105 transition-all duration-300 shadow-lg"
          >
